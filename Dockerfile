...
# package:
RUN pip install mysql-python  --index-url https://pypi.mirrors.ustc.edu.cn/simple/

# You'll need to install the required dependencies for Redis buffers:
RUN pip install redis hiredis nydus --index-url https://pypi.mirrors.ustc.edu.cn/simple/

ENV SENTRY_VERSION 8.0.0rc1

RUN pip install sentry==$SENTRY_VERSION --index-url https://pypi.mirrors.ustc.edu.cn/simple/
